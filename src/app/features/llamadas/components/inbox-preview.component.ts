      ...
      <div>
        ...
        <div style="display: flex; align-items: flex-start; gap: 12px; margin-bottom: 14px;">
          ...
          <div style="flex: 1; min-width: 0;">
            <div style="display: flex; align-items: center; gap: 8px;">
              <h3 style="margin: 0; font-size: 16px; font-weight: 700; color: #0f172a;">{{ l.cliente }}</h3>
        ...
        <div style="margin-bottom: 14px;">
          ...
          <div style="background: #f8fafc; padding: 10px; border-radius: 8px;">
            <app-emotion-arc [data]="l.emoji_arc" [width]="260" [height]="40" color="#3b82f6" />
        ...
        <div style="display: flex; flex-direction: column; gap: 6px; font-size: 12px; color: #475569;">
          ...
          <div style="display: flex; justify-content: space-between;">
            ...
            <span style="font-weight: 600; color: #0f172a;">{{ l.agenteId }}</span>
          </div>
          <div style="display: flex; justify-content: space-between;">
